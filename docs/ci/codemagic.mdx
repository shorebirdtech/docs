...
_If you're using the `codemagic.yaml`, please follow the instructions in the
[Codemagic YAML](#codemagic-yaml) section._

The documentation for the Workflow Editor is currently under development. Please
refer to the [Codemagic YAML](#codemagic-yaml) instructions in the meantime.

## Codemagic YAML

_If you are using Workflow Editor, please follow the instructions in [Codemagic
Workflow Editor](#codemagic-workflow-editor) section._
