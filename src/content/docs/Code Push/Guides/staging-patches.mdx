...
You should also
[submit the generated app bundles to the Play Store](/code-push/guides/submitting/play-store#upload-to-the-play-store)
and
[submit the generated ipa to the App Store](/code-push/guides/submitting/app-store#upload-to-the-app-store).
...
details page and click on the "Go Live" button.
