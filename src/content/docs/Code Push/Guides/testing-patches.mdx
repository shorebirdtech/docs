...
Shorebird’s mechanism to release to a subset of users is “tracks”. By convention
the “stable” track is distributed to all users of your app by default. When you
make a patch “live” it goes to “stable” and all users will update to that patch.
...
We have plans to
[allow additional track names in the future](https://github.com/shorebirdtech/updater/issues/255).
...
[Percentage Based Rollouts guide](/guides/percentage-based-rollouts) for
examples.
