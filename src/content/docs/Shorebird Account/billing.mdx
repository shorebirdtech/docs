...
You can view records of patch installs in
...
This will open Stripe's billing portal which includes the ability to change the
Stripe email, which is where invoices are sent.
