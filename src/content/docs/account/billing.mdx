...
Billing is tied to the **owner's account**, not to individual organizations. When
you create an organization, it inherits its plan from your subscription. This
means a single account can own multiple organizations and each organization
