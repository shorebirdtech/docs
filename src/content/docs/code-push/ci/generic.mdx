...
<LinkCard href="/code-push/ci/github" title="GitHub" description="Integrate Shorebird into your GitHub Actions workflows." />
<LinkCard href="/code-push/ci/codemagic" title="Codemagic" description="Integrate Shorebird into your Codemagic CI/CD pipelines." />

If you do not use these providers, we've also provided generic
instructions below:
