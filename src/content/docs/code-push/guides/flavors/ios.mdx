...
[submit the generated IPAs to the App Store](/code-push/guides/stores/app-store#upload-to-the-app-store).
...
Now that the internal and stable releases are on the App Store, a patch can be
