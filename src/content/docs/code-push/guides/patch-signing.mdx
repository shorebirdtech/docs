...
:::note Integrating with Cloud KMS requires that the executing environment (your
local terminal or CI/CD runner) has sufficient IAM credentials to read keys and
sign payloads.
