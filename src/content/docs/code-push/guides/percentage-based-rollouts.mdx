...
<Image src={rolloutGroup76Red} alt="Release build showing group number 76 with a red background" />
...
<Image src={rolloutFirestore50pct} alt="Cloud Firestore showing 1.0.0+1 at 50% rollout" />
...
<Image src={rolloutFirestore76pct} alt="Cloud Firestore showing 1.0.0+1 at 76% rollout" />
...
<Image src={rolloutGroup76Purple} alt="Patched build showing group number 76 with a purple background" />
