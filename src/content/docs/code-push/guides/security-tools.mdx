...
was built with obfuscation and apply the same obfuscation to the patch. No
...
:::note
Obfuscation support requires Flutter 3.41.2 or later. If you are using an
older version of Flutter, `shorebird release --obfuscate` will display an
...
binary. This may be incompatible with Shorebird's Dart modifications for iOS.
If this is an issue for your product, we'd be happy to discuss with your
