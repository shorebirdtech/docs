...
Shorebird’s mechanism to release to a subset of users is “tracks”. You can create
an unlimited number of tracks with arbitrary names. If no track is specified,
patches are distributed to the “stable” track by default.
