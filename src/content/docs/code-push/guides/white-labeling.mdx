...
This is a placeholder article. Shorebird seems to have many customers using it
within a white labeling environment, but the Shorebird team has little personal
experience with white labeling and would love to work with someone to update
this document to include your best practices.
...
be straightforward to build on top of what Shorebird does offer.
