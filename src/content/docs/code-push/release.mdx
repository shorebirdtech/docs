...
<LinkCard href="/code-push/guides/stores/play-store" title="Play Store Guide" description="Learn how to submit your release to the Google Play Store." />
<LinkCard href="/code-push/guides/stores/app-store" title="App Store Guide" description="Learn how to submit your release to the Apple App Store." />
