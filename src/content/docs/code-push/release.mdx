...
To create a patch for this release, run shorebird patch --platforms=macos --release-version=1.0.13+2
...
This will download the release artifacts and extract the compatible APK files to
your machine.
...
Android. We haven't had anyone try Shorebird with the iOS Developer Enterprise
...
/>
<LinkCard
  href="/code-push/guides/stores/play-store"
  title="Play Store Guide"
  description="Learn how to submit your release to the Google Play Store."
/>
<LinkCard
  href="/code-push/guides/stores/app-store"
  title="App Store Guide"
  description="Learn how to submit your release to the Apple App Store."
/>
