...
```sh
shorebird release ios --flutter-version 3.41.1
```
...
$ shorebird release linux
✓ Fetching apps (0.3s)
✓ Building app bundle with Flutter 3.41.1 (1e0e5760ee) (18.3s)
✓ Fetching releases (0.1s)
...
🕹️  Platform: linux
🐦 Flutter Version: 3.41.1 (1e0e5760ee)
...
```
shorebird release macos --flutter-version 3.41.1
```
...
$ shorebird release windows
✓ Fetching apps (0.3s)
✓ Building Windows app with Flutter 3.41.1 (1e0e5760ee) (18.3s)
✓ Fetching releases (0.1s)
...
```
shorebird release windows --flutter-version 3.41.1
```
