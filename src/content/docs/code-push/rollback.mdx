...
![](https://github.com/user-attachments/assets/941fdc46-d0f3-463f-835f-5c8eb8a02e83)

## What happens when a patch is rolled back?

Imagine we have a release with three patches:

![](https://github.com/user-attachments/assets/ee5d4e2b-eca3-4318-99e9-038c0134bfff)
...
![](https://github.com/user-attachments/assets/7ba4ff2c-5823-4c9f-a260-68ca6ce1e10a)
...
When a Shorebird app checks for new patches, the server includes in its repsonse
...
:::note If you app needs to download an older patch as part of a rollback,
installing that patch will count against your monthly patch intalls. :::
