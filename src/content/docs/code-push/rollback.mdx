...
<Image src={rollbackButton} alt='The Shorebird Console showing a "roll back patch" button' />

## What happens when a patch is rolled back?

Imagine we have a release with three patches:

<Image src={rollbackPatch3Active} alt="The Shorebird Console showing three patches, with patch 3 as the active patch" />
...
<Image src={rollbackPatch3RolledBack} alt="The Shorebird Console showing three patches, with patch 3 rolled back and patch 2 as the active patch" />
