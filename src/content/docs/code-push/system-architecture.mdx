...
is very different than on other platforms. Apple has policy and technical restrictions
about the mechanism through which iOS applications
are allowed to update. Shorebird is designed to comply with those
