...
we will likely expand to other cloud providers over time. For a full list of providers see our [privacy policy](https://shorebird.dev/privacy/). All of these services are currently
