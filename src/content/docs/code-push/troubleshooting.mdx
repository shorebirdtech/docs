...
**You swiped the app away on Android but the patch did not apply.**
...
the patch on the next process start. Force-stop the app, or stop the service
first, then relaunch. See
