...
A patch check request in the logs with `Shorebird updater: no active patch`
after a swipe-away, plus `adb shell ps | grep <your package>` still showing the
process, is how you tell.
