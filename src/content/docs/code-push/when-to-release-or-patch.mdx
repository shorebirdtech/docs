...
The most common and best fit scenario that patches are ment for, are changes that would fix a bug
in the app, a fix that don't change a feature behaviour, but rather just add a correction to a fault
