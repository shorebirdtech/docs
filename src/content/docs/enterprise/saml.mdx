...
expires, and Shorebird will re-read your metadata URL, or the new certificate as
PEM text if there is no URL. A certificate Shorebird has never seen breaks
sign-in for everyone on the domain the moment your IdP starts signing with it.
