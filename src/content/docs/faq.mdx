...
### When to send a patch

Generally, you should send patches that DO NOT contain native changes or assets changes. For all other
changes, you should likely create a new release.

If distributing through the stores be sure to refer to their policies for additional guidelines.
