...
### Will my app still work if I delete my account?

Yes, any user that have your app installed, or any that comes to install it from the store will
still be able to use it. However, no new patch install install will happen.
