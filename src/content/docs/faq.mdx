...
for [GitHub Actions](/ci/github), other CI systems should be similar.
...
[Uninstall](/uninstall) has details on how to remove Shorebird from your system
should you choose.
...
See [update-strategies](/update-strategies) for more information about how to
...
[our iOS releasing guide](/guides/submitting/app-store/#upload-to-the-app-store)
...
[stage the patch](/guides/staging-patches) or
[test the patch](/guides/testing-patches) before distributing to users and if
you encounter any complaints [roll back the patch](/code-push/rollback).
