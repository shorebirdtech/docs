...
For `StatefulWidgets`, the Element is what actually holds onto the `State` object you interact with daily.
...
and acts as the smart middleman that decides when actual heavy lifting needs to be done.
