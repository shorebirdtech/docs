---
title: 'Flutter Architecture: Widgets, Elements, and RenderObjects'
description:
...
- You'll understand why `Keys` are sometimes needed (they help the Element tree
...
- You'll realize why creating lots of widgets is totally fine, but stacking
  unnecessary deep widgets like `Opacity` or `Clip` (which create heavy
