...
[App Store](/flutter-concepts/releasing-flutter-apps/ios/) and
[Play Store](/flutter-concepts/releasing-flutter-apps/android/) guidelines.
...
the platform-specific guidelines in
[Releasing a Flutter App](/flutter-concepts/releasing-flutter-apps/). Implement
