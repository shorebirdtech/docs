...
To create an account, head over to our
[Web Console](https://console.shorebird.dev) and authenticate with one of the
...
To enable Shorebird for an existing Flutter app run:
