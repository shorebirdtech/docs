...
:::note We've shipped this version of patch signing to unblock certain customer
...
::: note On Windows, you can use the `openssl` that comes with your git
installation at `C:\Program Files\Git\usr\bin\openssl.exe`. :::
...
:::note We're using Android to demo, but this will work on any platform
Shorebird supports. :::
...
:::note Storing private keys on disk is not best-practice, and we recognize
