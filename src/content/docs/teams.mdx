...
_Roles are per-app._ Not all roles are publicly editable yet. If you
have any questions about access control for your app, please do not hesitate to
reach out to contact@shorebird.dev.

### App Developer (aka Collaborator)
...
Developer can be added and removed by any Admin, see below.
...
to add more robust teams support later this in 2024.
