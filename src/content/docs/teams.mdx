...
- Add unlimited collaborators to an indvididual app
- Manage roles for your app collaborators

Shorebird free "Hobby" users can upgrade to the Pro tier to add collaborators
via a link in the [Shorebird console](https://console.shorebird.dev).
