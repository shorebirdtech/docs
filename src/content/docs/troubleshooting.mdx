...
Install the correct Java version for the Gradle release your project is using and set the path
where it was installed in the `JAVA_HOME` environment variable.

Installing a specific version of Java can be trick, check [SDKMAN](https://sdkman.io/), a Java SDK
manager similar to `fvm` for an easy way of managing the Java versions in your environment.
